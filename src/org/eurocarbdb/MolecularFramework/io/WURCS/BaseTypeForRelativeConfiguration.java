...
public enum BaseTypeForRelativeConfiguration
{
	...
	public static BaseTypeForRelativeConfiguration forName( String a_strName ) throws WURCSException
	{
		...
		throw new WURCSException("Invalid value for basetype");
	}

	public static BaseTypeForRelativeConfiguration forStereoCode( String a_strCode ) throws WURCSException
	{
		...
		throw new WURCSException("Invalid value for basetype stereo code");
	}
