...
public enum SubstituentTypeToMAP {
    ...
    BROMO("bromo", "Br", null, null),
    CHLORO("chloro", "Cl", null, null),
    EPOXY("epoxy", "", null, null), // 0
    ETHANOLAMINE("ethanolamine", "NCCO", "NCC*", false),
    ...
    PYRUVATE("pyruvate", null, "C^X*/2CO/4=O/2C", null),  // sometime there is no chirality
    ...
    R_PYRUVATE("(r)-pyruvate", null, "C^R*/2CO/4=O/2C", null),
    S_LACTATE("(s)-lactate", "CC^SC/3O/2=O", null, null),
    S_PYRUVATE("(s)-pyruvate", null, "C^S*/2CO/4=O/2C", null),
