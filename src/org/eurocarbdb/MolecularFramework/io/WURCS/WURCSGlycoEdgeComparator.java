...
/**
 * Class of GlycoEdge comparator for WURCS (same to GlycoCT)
 * @author MasaakiMatsubara
 *
 */
public class WURCSGlycoEdgeComparator implements Comparator<GlycoEdge> ,Serializable
{
	...
	public int compare(GlycoEdge arg0, GlycoEdge arg1)
	{
		...
		// compare size of GlycoEdge, bigger comes first (Cardinality)
		...
		// compare LinkageList
		WURCSLinkageComparator t_oLinComp = new WURCSLinkageComparator ();
		...
		WURCSGlycoNodeComparator t_comp = new WURCSGlycoNodeComparator ();
