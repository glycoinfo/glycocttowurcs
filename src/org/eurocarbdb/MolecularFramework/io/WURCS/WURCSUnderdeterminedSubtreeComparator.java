...
/**
 * Class of underdetermined subtree comparator for WURCS (same to GlycoCT)
 * @author MasaakiMatsubara
 *
 */
public class WURCSUnderdeterminedSubtreeComparator implements  Comparator<UnderdeterminedSubTree> {
	...
	public int compare(UnderdeterminedSubTree arg0, UnderdeterminedSubTree arg1) {
		...
		WURCSGlycoEdgeComparator t_oEdgeComparator = new WURCSGlycoEdgeComparator();
